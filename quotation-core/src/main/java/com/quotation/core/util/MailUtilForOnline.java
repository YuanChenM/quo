 ...
 *
 */
public class MailUtilForOnline extends Thread {
    ...
    /** logger */
    private static Logger logger = LoggerFactory.getLogger(MailUtilForOnline.class);
     ...
     */
    public MailUtilForOnline(String to, String title, String body, final Vector<File> files,
        boolean isHtmlMail, File tempFolder) throws AddressException, MessagingException {
